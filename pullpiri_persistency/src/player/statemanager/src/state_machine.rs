...
impl StateMachine {
    ...
    pub fn process_model_state_update(
        ...
        TransitionResult {
            ...
            actions_to_execute: vec!["update_persistency".to_string()],
    ...
    ///
    /// This function queries PERSISTENCY to get all model states and filters them
    ...
    pub async fn get_models_for_package(
        ...
        // Get package definition from PERSISTENCY to find its models
    ...
    pub async fn find_packages_containing_model(
        ...
        // Get all packages from PERSISTENCY with prefix
        match common::persistency::get_all_with_prefix("Package/").await {
            ...
            Err(e) => {
                println!("    Failed to get packages from PERSISTENCY: {:?}", e);
                return Err(format!("Failed to get packages from PERSISTENCY: {:?}", e));
            }
        }
    ...
    /// Get current package state from PERSISTENCY
