...
"#
    ...
    async fn test_send_guest_no_nodes_found() {
        ...
        // This will try to find guest nodes in persistency
    ...
    async fn test_send_guest_with_mock_data() {
        ...
        // The send_guest function will look for guest nodes in persistency
        ...
        match error.code() {
            Code::NotFound => {
                assert_eq!(error.message(), "No guest nodes found in persistency");
            }
            Code::Unavailable => {
