...
pub enum MetricValue {
    ...
    // Resource-based metric types (matching persistency data)
...
impl MonitoringManager {
    ...
    pub async fn get_metrics(
        ...
        // Fetch from monitoring PERSISTENCY directly
        let metrics = self.fetch_metrics_from_monitoring_persistency(filter).await?;
    ...
    /// Fetch metrics directly from monitoring PERSISTENCY
    async fn fetch_metrics_from_monitoring_persistency(
        &mut self,
        filter: Option<&MetricsFilter>,
    ) -> Result<Vec<Metric>, SettingsError> {
        let mut metrics = Vec::new();

        // Get nodes and convert to Metric format - using monitoring_persistency
        match crate::monitoring_persistency::get_all_nodes().await {
            Ok(nodes) => {
        ...
        // Get containers and convert to Metric format - using monitoring_persistency
        match crate::monitoring_persistency::get_all_containers().await {
            Ok(containers) => {
        ...
        // Get SoCs and convert to Metric format - using monitoring_persistency
        match crate::monitoring_persistency::get_all_socs().await {
            Ok(socs) => {
        ...
        // Get boards and convert to Metric format - using monitoring_persistency
        match crate::monitoring_persistency::get_all_boards().await {
            Ok(boards) => {
        ...
        info!("Fetched {} metrics from monitoring PERSISTENCY", metrics.len());
        Ok(metrics)
    }

    /// Get all node metrics - SIMPLIFIED to use monitoring_persistency directly
    ...
    /// Get all container metrics - SIMPLIFIED to use monitoring_persistency directly
    pub async fn get_container_metrics(&mut self) -> Result<Vec<ContainerInfo>, SettingsError> {
        debug!("Getting all container metrics");

        crate::monitoring_persistency::get_all_containers()
            .await
            .map_err(|e| {
    ...
    pub async fn get_container_metric_by_id(
        ...
        match crate::monitoring_persistency::get_container_info(container_id).await {
            Ok(container) => Ok(Some(container)),
            Err(crate::monitoring_persistency::MonitoringPersistencyError::NotFound) => Ok(None),
    ...
    pub async fn get_container_logs(
        ...
        crate::monitoring_persistency::get_container_logs(container_id)
            .await
            .map_err(|e| {
                SettingsError::Storage(crate::settings_utils::error::StorageError::OperationFailed(
    ...
    /// Get all soc metrics - SIMPLIFIED to use monitoring_persistency directly
    ...
    /// Get all board metrics - SIMPLIFIED to use monitoring_persistency directly
    ...
    /// Get node metric by name - SIMPLIFIED to use monitoring_persistency directly
    pub async fn get_node_metric_by_name(
        ...
        match crate::monitoring_persistency::get_node_info(node_name).await {
    ...
    pub async fn delete_metric(
        ...
        match component {
            "nodes" => {
                crate::monitoring_persistency::delete_node_info(metric_id)
                    .await
                    .map_err(|e| {
            ...
            "containers" => {
                crate::monitoring_persistency::delete_container_info(metric_id)
                    .await
                    .map_err(|e| {
            ...
            "socs" => {
                crate::monitoring_persistency::delete_soc_info(metric_id)
                    .await
                    .map_err(|e| {
            ...
            "boards" => {
                crate::monitoring_persistency::delete_board_info(metric_id)
                    .await
                    .map_err(|e| {
    ...
    pub async fn get_metric_by_id(
        ...
        if let Ok(node_info) = crate::monitoring_persistency::get_node_info(metric_id).await {
            let metric = Metric {
                id: node_info.node_name.clone(),
                component: "node".to_string(),
                metric_type: "NodeInfo".to_string(),
        ...
        if let Ok(container_info) = crate::monitoring_persistency::get_container_info(metric_id).await {
            let metric = Metric {
                id: container_info.id.clone(),
                component: "container".to_string(),
                metric_type: "ContainerInfo".to_string(),
